...
export const en = {
    ...
    'page.body.landing.features.features.item1.text': 'ZDAX offers the most liquid order book in the world, allowing users to easily exchange Bitcoin, Ethereum, Sumcoin, Litecoin, Sumcoin Classic, DigiByte and many other digital assets with minimal slippage.',
